...
---@field on_change function() Callback function that is called when the colorscheme is updated. This is helpful for updating plugins that might need manual changes when the colorscheme changes
